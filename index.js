...
𝙃𝙊𝙇𝘼 𝘽𝙄𝙀𝙉𝙑𝙀𝙉𝙄𝘿@ 𝙉𝙊 𝙊𝙇𝙑𝙄𝘿𝙀𝙎 𝙈𝘼𝙉𝘿𝘼𝙍 𝙏𝙐 𝙋𝘼𝘾𝙆 𝘼 𝙇𝙊𝙎 𝘼𝘿𝙈 𝙂𝙍𝙐𝙋𝙊 : 
*${mdata.subject}*
────────────────
┏━━━━━━━━━━━━━━━━━━━━
┃──────〘  *Intro* 〙───────
...
┠⊷️ *Nombre* :
┠⊷️ 𝙍𝙀𝙂𝙇𝘼𝙎
┠⊷️ 1 𝙉𝙊 𝙃𝘼𝙔 𝙍𝙀𝙂𝙇𝘼𝙎 𝙓𝘿𝙓𝘿
┠⊷️ 2 𝙃𝘼𝙕 𝙇𝙊 𝙌𝙐𝙀 𝙌𝙐𝙄𝙀𝙍𝘼𝙎 𝙋𝙀𝙉𝘿𝙀𝙅@
┗━━━━━━━━━━━━━━━━━━━━

𝗗𝗶𝗴𝗶𝘁𝗮 ${prefix}.𝗣𝗮𝗿𝗮 𝗽𝗼𝗱𝗲𝗿 𝘂𝘀𝗮𝗿𝗺𝗲, 𝗮𝘀𝗶 𝗰𝗼𝗺𝗼 𝗲𝗹 𝗼 𝗲𝗹𝗹𝗮  𝘁𝗲 𝘂𝘀𝗼 𝗮𝘁𝗶'
				Lxa.sendMessage(mdata.id, teks, MessageType.text, { contextInfo: {"mentionedJid": [num]}})
			} else if (anu.action == 'remove') {
				num = anu.participants[0]
				teks = `𝗤𝘂𝗲 𝗯𝘂𝗲𝗻𝗼 𝗾𝘂𝗲 𝗦𝗮𝗹𝗶𝗼/𝗘𝗹𝗶𝗺𝗶𝗻𝗮𝗿𝗼𝗻 𝗮 @${num.split('@')[0]} 𝗜𝗴𝘂𝗮𝗹 𝗻𝗮𝗱𝗶𝗲 𝗹𝗼 𝗾𝘂𝗶𝗲𝗿𝗲 𝗝𝗔𝗝𝗔𝗝𝗔`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	Lxa.on('chat-update', async (mek) => {
      ...
      const is = budy.slice(0).trim().split(/ +/).shift().toLowerCase()
			mess = {
  wait: '⏳ Aɢᴜᴀɴᴛᴀᴍᴇ ᴡᴇ ʏᴀ ᴠᴏʏ ( Esᴘᴇʀᴀ) ',
  success: '🎉 Con sᴜᴄᴄᴇsᴏ',
  Public: '🛡 Modo privado activado',
  ferr: 'Lo siento ocurrio un error ( Pᴀsᴀ ᴘᴏʀ sᴇʀ ɢᴀʏ xD )',
  limitend: 'El tiempo se agoto',
  error: {
  stick: 'Cᴏʀʀɪɢᴇ ᴇ ɪɴᴛᴇɴᴛᴀʟᴏ ᴏᴛʀᴀ ᴠᴇᴢ ʙʙ',
  Iv: 'Error en el link'
  },
  only: {
    group: 'Este comando solo puede ser usado en grupos',
    ownerG: 'Este comando solo puede ser usado por el dueño del grupo',
    ownerB: 'Este comando solo puede ser usado por ᴇʟ ᴄʀᴇᴀᴅᴏʀ ᴅᴇʟ ʙᴏᴛ [ 𝗠𝗜𝗧𝗢 ]',
    admin: 'Nᴇᴄᴇsɪᴛᴀs sᴇʀ ᴀᴅᴍɪɴɪsᴛʀᴀᴅᴏʀ ᴅᴇʟ ɢʀᴜᴘᴏ ᴘᴀʀᴀ ᴜsᴀʀ ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ',
    Badmin: '𝗪𝗔𝗟𝗟𝗜𝗘 ( BOT ) Dᴇʙᴇ sᴇʀ ᴀᴅᴍɪɴɪsᴛʀᴀᴅᴏʀ ᴅᴇʟ ɢʀᴜᴘᴏ ᴘᴀʀᴀ ᴜsᴀʀ ᴇsᴛᴇ ᴄᴏᴍᴀɴᴅᴏ',
    daftarB: `𝗛𝗢𝗟𝗔 𝗕𝗕 𝗗𝗜𝗚𝗜𝗧𝗔 > *${prefix}verify* 𝗣𝗔𝗥𝗔 𝗨𝗦𝗔𝗥𝗠𝗘 𝗔𝗦𝗜 𝗖𝗢𝗠𝗢 𝗘𝗟𝗟𝗔 𝗧𝗘 𝗨𝗦𝗢 𝗔𝗧𝗜'
  }
}
...
case 'menu':
hasil = `        ────────────────
𝙃𝙊𝙇𝘼 > *${pushname}* 𝙋𝘼𝙍𝘼 𝙋𝙊𝘿𝙀𝙍 𝙑𝙀𝙍 𝙈𝙄𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎 𝘽𝙄𝙀𝙉 𝙈𝘼𝙈𝘼𝙇𝙊𝙉𝘼𝙎 𝗗𝗜𝗚𝗜𝗧𝗔 > ${prefix}menu
        ────────────────`
reply(hasil)
        break
}
...
┃ _Ex : ${prefix}Ephoto 25 𝗠𝗜𝗧𝗢_
┠⊷️ *${prefix}Textpro list*
┃ _Lista de textpro
┠⊷️ *${prefix}Textpro (code + Texto)*
┃ _Ex : ${prefix}Textpro 55 𝗠𝗜𝗧𝗢_
┗━━━━━━━━━━━━━━━━━━━━
*〘 𝗜𝗠𝗔𝗚𝗘𝗡𝗘𝗦 〙*
┏━━━━━━━━━━━━━━━━━━━━
┠⊷️ *${prefix}Cogan*
...
fs.unlinkSync(rano)
  ...
  reply('PRIMERO ENVIA LA FOTO PENDEJ@')
}
break
...
if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
 ...
 Lxa.sendMessage(from, hehe, image, {quoted:mek})
  ...
  reply('PRIMERO ENVIA LA FOTO BB')
}
break
...
//--block user
				case 'blocklist':
					teks = 'Lista de bloqueados por el bot Mito no te quiere bro :( :\n'
...
//--menurunkan jabatan
				case 'demote':
					...
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = 'Admin quitado con exito esta puta ya no es admin\n'
						for (let _ of mentioned) {
							teks += `@${_.split('@')[0]}\n`
						}
...
case 'daftar':
  case 'register':
if (isRegister) return reply('𝗧𝗨 𝗖𝗨𝗘𝗡𝗧𝗔 𝗬𝗔 𝗘𝗦𝗧𝗔 𝗘𝗡 𝗠𝗜 𝗕𝗔𝗦𝗘 𝗗𝗘 𝗗𝗔𝗧𝗢𝗦 ')
...
tm = `𝗩𝗘𝗥𝗜𝗙𝗜𝗖𝗔𝗗𝗢 𝗖𝗢𝗡 𝗘𝗫𝗜𝗧𝗢 𝗟𝗜𝗦𝗧𝗢 𝗕𝗕 √ 𝗗𝗜𝗚𝗜𝗧𝗔 ${prefix}Menu 𝗣𝗔𝗥𝗔 𝗩𝗘𝗥 𝗠𝗜𝗦 𝗙𝗨𝗡𝗖𝗜𝗢𝗡𝗘𝗦 𝗠𝗔𝗠𝗔𝗟𝗢𝗡𝗔𝗦`
reply(tm)
break
...
break
				...
				case 'welcome':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (args.length < 1) return reply('𝗧𝗔 𝗕𝗜𝗘𝗡 𝗕𝗕 𝗔𝗟𝗥𝗔𝗧𝗢 𝗟𝗢 𝗣𝗢𝗡𝗚𝗢')
					if (Number(args[0]) === 1) {
  ...
  reply(`        ────────────────\n𝗛𝗢𝗟𝗔 *${pushname}* !!!\n 𝗘𝗦𝗘 𝗖𝗢𝗠𝗔𝗡𝗗𝗢 : *${prefix}${command}*\n 𝗡𝗢 𝗘𝗦𝗧𝗔 𝗘𝗡 𝗠𝗜 𝗕𝗔𝗦𝗘 𝗗𝗘 𝗗𝗔𝗧𝗢𝗦, 𝗨𝗦𝗔 𝗘𝗦𝗧𝗘 𝗣𝗔𝗥𝗔 𝗩𝗘𝗥 𝗟𝗢𝗦 𝗖𝗢𝗠𝗔𝗡𝗗𝗢𝗦 𝗗𝗜𝗦𝗣𝗢𝗡𝗜𝗕𝗟𝗘𝗦*${prefix}Menu*\n        ────────────────`)
				}
