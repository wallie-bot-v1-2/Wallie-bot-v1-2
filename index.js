...
BIENVENID@ DIGITA " #verify " PARA USARME nombre del grupo :
*${mdata.subject}*
────────────────
┏━━━━━━━━━━━━━━━━━━━━
┃──────〘  *Intro* 〙───────
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
  ...
  only: {
    ...
    daftarB: `HOLA, DIGITA*${prefix}verify* PARA USARME`
  }
}
...
//--menurunkan jabatan
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Un admi menos @${mentioned[0].split('@')[0]} por puta!`, mentioned, true)
...
case 'daftar':
  case 'register':
if (isRegister) return reply('Tu cuenta ya estaba verificada puta')
...
tm = `verificacion completada con exito DIGITA ${prefix}Menu para ver las funciones facheritas`
reply(tm)
break
...
break
  ...
  reply(`        ────────────────\nHola pendej@ *${pushname}* !!!\nEse comando no esta en mi base de datos : *${prefix}${command}*\nUsa esto para ver los disponibles o dile a papi MITO que lo agregue*${prefix}Menu*\n        ────────────────`)
				}
